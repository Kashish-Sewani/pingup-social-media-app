...
const StoriesBar = () => {
    ...
    overflow-x-auto px-4'>
            ...
            cursor-pointer hover:shadow-lg tranistion-all duration-200 border-2 border-dashed
                ...
                {/* Story Cards */}
                {
                    stories.map((story, index) => (
                        ...
                        className={`relative rounded-lg shadow min-w-30 max-w-30
                         max-h-40 cursor-pointer hover:shadow-lg tranistion-all duration-200
                         bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700
                       hover:to-purple-800 active:scale-95`}>
                            <img src={story.user.profile_picture} alt="" className='absolute size-8
                        top-3 left-3 z-10 rounded-full ring ring-gray-100 shadow'/>
