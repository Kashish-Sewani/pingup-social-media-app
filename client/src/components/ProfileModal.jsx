            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={e=> toast.promise(
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        ...
                        text-gray-700 mb-1'>
                            Profile Picture
                            <input type="file" hidden id="profile_picture" accept="image/*" 
                            className='w-full p-3 border border-gray-200 rounded-lg' 
                            onChange={(e)=>setEditForm({...editForm, profile_picture:
                             e.target.files[0]})}/>
                             <div className='group/profile relative'>
                                <img src={editForm.profile_picture ? 
                                URL.createObjectURL(editForm.profile_picture) : user.profile_picture} alt="" 
                                className='w-24 h-24 rounded-full object-cover mt-2'/>
                                
                                <div className='absolute hidden group-hover/profile:flex top-0 right-0 left-0
                 ...
                 <div className='flex flex-col items-start gap-3'>
                    <label htmlFor="cover_photo" className='block text-sm font-medium
                     text-gray-700 mb-1'>
                        Cover Photo
                        <input type="file" hidden id="cover_photo" accept="image/*" 
                        className='w-full p-3 border border-gray-200 rounded-lg' 
                        onChange={(e)=>setEditForm({...editForm, cover_photo:
                        e.target.files[0]})}/>
                        <div className='group/cover relative'>
                            <img src={editForm.cover_photo ? 
                            URL.createObjectURL (editForm.cover_photo) : user.cover_photo} alt="" 
                 ...
                 <div className='flex justify-end space-x-3 pt-6'>
                    ...
                    to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700
