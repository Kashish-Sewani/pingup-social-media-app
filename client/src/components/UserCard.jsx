...
const UserCard = ({user}) => {
  ...
  return (
    <div key={user._id} 
    className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200
    rounded-md'>
      ...
      <div className='flex mt-4 gap-2'>
        {/* Follow Button */}
        <button disabled={currentUser?.following.includes(user._id)} onClick={handleFollow}
        ...
        className='flex items-center justify-center w-16 border text-slate-500 group
