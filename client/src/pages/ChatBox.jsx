...
import { ImageIcon, SendHorizonal, UserRoundCheck } from 'lucide-react';
...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
      <div className='flex items-center gap-2 p-2md:px-10 xl:pl-42 bg-gradient-to-r from-indigo-50
          ...
          <label htmlFor="image">
            {
              image
                ...
                : <ImageIcon className='cursor-pointer size-7 text-gray-400' />
            }
            <input type="file" id="image" aceept='image/*' hidden
